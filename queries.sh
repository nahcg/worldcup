...
echo "$($PSQL "SELECT DISTINCT(name) FROM games INNER JOIN teams ON teams.team_id = games.winner_id OR teams.team_id = opponent_id WHERE round = 'Eighth-Final' AND year = 2014")"
